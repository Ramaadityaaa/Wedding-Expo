...
export default function OrdersPage({ orders }) {
    // Cek jika data orders kosong atau tidak ada
    ...
    return (
        <div className="max-w-7xl mx-auto py-12 px-6 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
                {/* Loop melalui orders untuk menampilkan daftar pesanan */}
                {orders.map((order) => (
                    <div key={order.id} className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                        {/* Nama Paket */}
                        ...
                        <Link href={`/customer/orders/${order.id}`} className="text-blue-500 hover:text-blue-700">
                            Lihat Detail
                        </Link>
                    </div>
                ))}
