...
  FaEnvelope,
  FaLock,
  FaEye, // Import ikon mata tertutup
  FaEyeSlash, // Import ikon mata terbuka
  FaFacebookF,
  FaGoogle,
  FaLinkedinIn,
} from 'react-icons/fa';
...
            {/* Password - DITINGKATKAN */}
            <div className="relative">
              <FaLock className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400" />
              <input
                // Menetapkan tipe input secara dinamis
                type={showPassword ? 'text' : 'password'} 
                placeholder="Password"
                value={data.password}
                onChange={(e) => setData('password', e.target.value)}
                required
                // Menambahkan padding kanan agar tombol ikon tidak menimpanya
...
              />
                ...
                <button
                    ...
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors p-1 rounded-full"
                >
                    {/* Tampilkan ikon mata tertutup atau terbuka */}
