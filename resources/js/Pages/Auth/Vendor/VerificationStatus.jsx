                ...
                return (
                    <div className="text-center p-10 bg-white shadow-xl rounded-xl max-w-lg mx-auto border-t-4 border-green-500">
                        ...
                        <p className="text-lg text-gray-600 mb-6">
                            Tim administrasi kami telah meninjau dan menyetujui
                            akun vendor Anda.
                        </p>
                        <p className="text-sm text-gray-500 mb-6">
                            Sekarang Anda dapat mulai mengelola profil, menambah
                            layanan, dan berinteraksi dengan calon pengantin.
                        </p>
            ...
            case "rejected":
                return (
                    <div className="text-center p-10 bg-white shadow-xl rounded-xl max-w-lg mx-auto border-t-4 border-red-600">
                        ...
                        <h1 className="text-3xl font-bold text-gray-800 mb-3">
                            Mohon Maaf, Akun Ditolak
                        </h1>
                        <p className="text-lg text-gray-600 mb-4">
                            Akun Anda belum memenuhi persayaratan untuk menjadi
                            vendor bagian kami.
                        </p>
                        {rejectionReason && (
                        ...
                        <p className="text-sm text-gray-500 mb-6">
                            Silakan hubungi admin atau perbaiki data Anda dan
                            daftar ulang.
                        </p>
            ...
            default:
                return (
                    <div className="text-center p-10 bg-white shadow-xl rounded-xl max-w-lg mx-auto border-t-4 border-yellow-500">
                        ...
                        <p className="text-lg text-gray-600 mb-6">
                            Terima kasih telah mendaftar. Tim admin kami sedang
                            meninjau kelengkapan dan persyaratan data Anda.
                        </p>
                        <div className="bg-yellow-50 p-3 rounded-lg border border-yellow-100 mb-4">
                            <p className="text-sm text-yellow-700 animate-pulse">
                                Halaman ini akan otomatis dialihkan jika status
                                Anda berubah.
                            </p>
                        </div>
